...
public class RandomImageGenerator {
    ...
    private void generateByNumberOfFiles(int no_of_files, String path) throws IOException {
    ...
    private void generateBySize(int dataset_size_mb, String path) throws IOException {
    ...
    private void generateBySizeCount(int dataset_size_mb_in, int no_of_files_in, String path_in) throws IOException {
    ...
    private void runLoop(int no_of_files_in, String path_in) throws IOException {
    ...
    private long generateImage(String path_name) throws IOException {
        Random rand = new Random();
    ...
    public static void main(String[] args) {
        ...
        try {
            RMI.generateImage("C:\\dev\\imggen\\src\\main\\resources");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
